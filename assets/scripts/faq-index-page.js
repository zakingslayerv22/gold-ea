...
class FaqServiceHomepage {
    ...
    #faqData = {
        1: {
            ...
            questions: {
                1: {
                    ...
                    a: "GoldTrap EA is an Expert Advisor for MetaTrader 4 and MetaTrader 5, built specifically for XAUUSD (Gold) trading. It uses a straddle-entry strategy, grid recovery, basket take profit, license binding, and strict risk control to manage trades automatically according to your configured settings."
                },
                2: {
                    q: "Who is GoldTrap EA for?",
                    a: "GoldTrap EA is designed for traders who prefer consistency over manual execution. It suits both newer traders who want a structured, rules-based approach and experienced traders who want to automate gold trading across one or more accounts."
                },
                3: {
                    q: "Can GoldTrap EA be used on MT4 and MT5?",
                    a: "Yes. GoldTrap EA ships as a compiled .ex4 file for MetaTrader 4 and a compiled .ex5 file for MetaTrader 5. Your licence covers both platforms, so you can install whichever build matches your terminal."
                },
                4: {
                    q: "Can I run GoldTrap EA on a mobile phone?",
                    a: "No. The MetaTrader mobile apps cannot run Expert Advisors. GoldTrap EA must run inside a desktop MetaTrader terminal, which is why most users run it on a VPS so it stays online around the clock."
                },
                5: {
                    q: "Which pair does GoldTrap EA trade?",
                    a: "GoldTrap EA is optimised for XAUUSD (Gold). Its entry logic, recovery behaviour and risk defaults are tuned specifically for the way gold moves, so running it on other symbols is not recommended."
                },
                6: {
                    q: "What strategy does GoldTrap EA use?",
        ...
        2: {
            ...
            questions: {
                1: {
                    q: "Can I use GoldTrap EA with any broker?",
                ...
                2: {
                    q: "Does GoldTrap EA work on cent and standard accounts?",
                    a: "Yes. GoldTrap EA runs on both cent and standard accounts. Cent accounts are a practical way to run the EA with smaller real capital while you get familiar with how it behaves."
                },
                3: {
                ...
                5: {
                    ...
                    a: "Yes. Message Abang Rimba on Telegram with your current and new account IDs and your licence will be re-bound. You stay within the account allowance of the plan you purchased."
                },
                6: {
        ...
        3: {
            ...
            questions: {
                ...
                3: {
                    ...
                    a: "GoldTrap EA includes built-in risk management features, a configurable daily profit target, basket-level take profit, and a trading pause that stops new entries during unstable rollover periods while continuing to manage positions that are already open."
                },
                4: {
                ...
                6: {
                    ...
                    a: "Licences and the source code are sold as one-time payments with no refund. If you are unsure whether GoldTrap EA fits your setup, start with the free option or ask your questions on Telegram first."
                }
            }
        },
        ...
        4: {
            ...
            questions: {
                1: {
                    q: "How do I install GoldTrap EA?",
                ...
                3: {
                    ...
                    a: "After payment, send your transaction screenshot and your MT4/MT5 account IDs to Abang Rimba on Telegram. Your licence key is issued and bound to those accounts."
                },
                4: {
                ...
                5: {
                    q: "Do I need a VPS?",
                    a: "A VPS is strongly recommended. GoldTrap EA is VPS friendly and only manages trades while the terminal is running, so a VPS keeps it online even when your own computer is off."
                },
                6: {
                    q: "How do I get support?",
                    a: "Support runs through Telegram, direct with Abang Rimba. The 5 Accounts and Unlimited licences both include priority reply, and source-code buyers get direct support on integration and customisation."
                }
            }
        }
    };
